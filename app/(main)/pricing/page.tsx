        ...
        <main className="flex-1 bg-background text-foreground pb-20">
                        ...
                        return (
                            ...
                            >
                                    ...
                                    <ul className="space-y-3.5">
                                        {plan.features.map((f, i) => (
                                            <li key={i} className="flex items-start gap-3 text-sm">
                                                <CheckCircle2 className={`h-5 w-5 shrink-0 mt-0.5 ${plan.isPopular ? "text-violet-400" : "text-primary"}`} />
                                                <span>{f}</span>
                                            </li>
                                        ))}
                                    </ul>
                                ...
                                <CardFooter className="pt-4">
                                    <Button
                                        className={`w-full h-11 font-semibold transition-all duration-200 ${plan.isPopular
            ...
            <div className="mx-auto max-w-xl text-center mt-12">
                <p className="text-sm text-muted-foreground">
                    ...
                    Cancel anytime from your dashboard. Prices in USD.
                </p>
            </div>
        </main>
    );
