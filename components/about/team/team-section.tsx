...
export default function TeamSection() {
  ...
  return (
    <section className="text-center px-6 py-6 bg-gradient-to-b from-black via-neutral-900 to-black">
      {/* Heading */}
      <h2 className="text-4xl md:text-5xl font-bold mb-14 bg-white bg-clip-text text-transparent tracking-wide">
        Our Team
      </h2>

      {/* Cards */}
      <div className="grid md:grid-cols-3 gap-8 max-w-6xl mb-12 mx-auto">
